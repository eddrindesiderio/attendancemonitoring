        ...
        <div class="container bg">
          <div class="row">
            ...
            <ul class="nav navbar-nav ssgmenu motto" id="footer_nav"> 
                <li ><a href="attendance/check_attendance.php" target="_blank"><i class="icon-info-sign"></i>CHECK ATTENDANCE STUDENTS</a></li>      
            </ul> 
            </div> 
          </div>
            <div class="row">
                          ...
                          <div class="title_index">
                                ...
                                <div class="row-fluid">
                                  <div class="span12"></div>
                                      <div class="row-fluid">
                                        <div class="span10">
                                        <img class="index_logo" src="DEVELOPERS/ICT_logo.jpg">
                                        </div>             
                                      </div>                    
                                </div>  
