...
<head>
    ...
    <title>ILS 2021 ATTENDANCE MONITORING SYSTEM</title>
...
<div id='cssmenu' style="margin-bottom: 130px">
<ul>
...
<div class="container"  style="min-height:660px;">
    ...
    <footer id="footer" class="midnight-blue" style="background-color: #52D3A8;border-top: 1px solid #52D3A8">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                     <a target="_blank" href="<?php echo web_root; ?>" title="DEVELOPERS">Attendance Monitoring System Control</a>. ICT STUDENTS.
					 <P>If you see something wrong kindly report to this email</p><h4 style="text-decoration:underline;">EXAMPLE@GMAIL.COM</h4>
