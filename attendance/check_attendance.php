                      ...
                      <div class="col-sm-7 wow fadeInDown"> 
                        ...
                        <div class="col-md-8"> 
                          	  ...
                          	  <ul class="list-group">
                                  ...
                                  <li class="list-group-item text-right"><span class="pull-left">ID NUMBER</span><input class="StudentID" type="text" id="StudentID"></li>
                                  <li class="list-group-item text-right"><span class="pull-left">Name</span><label id="name">N/A</label> </li>
                                  <li class="list-group-item text-right"><span class="pull-left">Course</span><label id="course">N/A</label></li>
                                  <li class="list-group-item text-right"><span class="pull-left">Year</span><label id="year">N/A</label> </li>
                                    
                                
                              </ul>  
                              <div id="check_attendance" style="color:#000"></div>   
...
<h2>
 ...
 <center>
   <footer>        
    <p  style="color:#fff;font-size: 12px">Attendance Monitoring System  </p>  
    </footer>
</center>
